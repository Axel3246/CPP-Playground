...
class Videos{
    public:
        Videos();
        Videos(string iD, string nombre, string genero, string duracion, double calificacion);
        //Metodos SET
        ...
        double getCalificacion(){return this->calificacion;}
...
Videos::Videos(string iD, string nombre, string genero, string duracion, double calificacion){
    this->iD = iD;
    this->nombre = nombre;
