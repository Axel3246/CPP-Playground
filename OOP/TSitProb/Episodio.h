...
public:
    ...
    Episodio(string _iD, string _nombre, string _genero, string _duracion, double _calificacion, string titulo, int temporada, int calificacionEp);
    //SET
...
Episodio::Episodio(string _iD, string _nombre, string _genero, string _duracion, double _calificacion, string titulo, int temporada, int calificacionEp) : Videos(_iD, _nombre, _genero, _duracion, _calificacion)
{
    this->titulo = titulo;
